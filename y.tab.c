...
{
       0,    78,    78,    90,    93,    95,    99,   102,   107,   111,
     113,   117,   121,   125,   130,   134,   138,   146,   148,   153,
     155,   157,   159,   161,   163,   165,   167,   169,   171,   173,
     175,   179,   181,   183,   185,   187,   189,   191,   196,   198
};
#endif
...
/* Line 1455 of yacc.c  */
#line 179 "62.y"
    {(yyval.ptr)=makenode((yyvsp[(1) - (3)].ptr),(yyvsp[(3) - (3)].ptr),'+',0,DUMMY); if(!type_check((yyval.ptr),0)==0) TypeFlag = 0;}
    break;
...
/* Line 1455 of yacc.c  */
#line 187 "62.y"
    {(yyval.ptr)=makenode((yyvsp[(1) - (3)].ptr),(yyvsp[(3) - (3)].ptr),_mod,0,DUMMY);if(!type_check((yyval.ptr),0)==0) TypeFlag = 0;}
    break;
